...
describe('validation', () => {
  ...
  it('agentProfileSchema rejects empty displayName: `agentProfileSchema.safeParse({ displayName: \' \', framework: \'x\', tags: [] })` returns `success: false`; `result.error.issues` is non-empty', () => {
